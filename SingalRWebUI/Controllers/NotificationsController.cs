...
using SingalRWebUI.Dtos.NotificationDtos;
using System.Text;
...
namespace SingalRWebUI.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> CreateNotification(CreateNotificationDto createNotificationDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7112/api/Notification", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync($"https://localhost:7112/api/Notification/NotificationStatusChangeToTrue/id");
            return RedirectToAction("Index");
        }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync($"https://localhost:7112/api/Notification/NotificationStatusChangeToFalse/id");
            return RedirectToAction("Index");
        }
    }
}
