...
using SingalRWebUI.Dtos.BookingDtos;
using System.Text;
...
namespace SingalRWebUI.Controllers
{
    public class BookingController : Controller
    {
        ...
        public async Task<IActionResult> CreateBooking(CreateBookingDto createBookingDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7112/api/Booking", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync($"https://localhost:7112/api/Booking/BookingStatusCancelled/{id}");
            return RedirectToAction("Index");
        }
    }
}
